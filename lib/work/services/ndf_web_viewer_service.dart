...
.todo-badge--high { border-color: var(--accent); color: var(--accent); }
.todo-expand-chevron {
...
.todo-update {
  ...
  padding: 8px 10px;
  margin-bottom: 6px;
  border-left: 2px solid var(--accent-alpha-70);
  border-radius: 0;
  font-size: 0.85rem;
}
...
''';
  ...
  String _getFeedbackStyles() => feedback.getFeedbackStyles();
...
''';
  ...
  String _getLikesScript(String authorNpub, int likesCount, List<String> likedHexPubkeys, String filename)
      => feedback.getLikesScript(authorNpub, likesCount, likedHexPubkeys, filename);

  String _getCommentsScript(String ownerNpub, String filename)
      => feedback.getCommentsScript(ownerNpub, filename);
}
