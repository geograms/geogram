...
<div class="message" data-timestamp="${escapeHtml(msg.timestamp)}">
  ...
  /// Folder names of wapps the launcher should surface — every entry
  /// under `<baseDir>/wapps/` with a manifest.json. The runtime always
  /// reads from the local archive; source-tree edits become visible
  /// only after a reinstall (Reload button or wapp store update).
