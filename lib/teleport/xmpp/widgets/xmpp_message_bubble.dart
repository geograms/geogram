 ...
 * License: Apache-2.0
 *
 * XMPP message bubble widget — dark-mode style matching Telegram/IRC bubbles.
...
class XmppMessageBubble extends StatelessWidget {
  final XmppMessage message;
  final bool showSender;

  const XmppMessageBubble({
    super.key,
...
/// Centered system message (join/leave/subject) — not a bubble.
class XmppSystemMessage extends StatelessWidget {
  final XmppMessage message;

  const XmppSystemMessage({super.key, required this.message});
