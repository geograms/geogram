...
/// Model representing a comment on an event or event item
class EventComment {
  final String author;
  ...
  @override
  String toString() {
    return 'EventComment(author: $author, timestamp: $timestamp, content: ${content.substring(0, content.length > 50 ? 50 : content.length)}...)';
  }
}
