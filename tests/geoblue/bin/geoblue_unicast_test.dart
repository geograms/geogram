...
Future<int> main(List<String> args) async {
  ...
  final incomingSub = session.incomingFrames.listen((frame) {
    final from = frame.payload['from']?.toString() ??
  ...
  try {
    ...
    stdout.writeln('HELLO OK with ${peerCallsign.isEmpty ? 'peer' : peerCallsign}');
    ...
    stdout.writeln('Desktop -> ESP32 -> Desktop roundtrip time: ${roundTripMs} ms');
