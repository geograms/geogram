...
{
#if BOARD_MODEL == MODEL_KV4P
    ESP_LOGI(TAG, "HTTP GET / (Chat page)");
    httpd_resp_set_type(req, "text/html");
    httpd_resp_send(req, CHAT_PAGE_HTML, strlen(CHAT_PAGE_HTML));
#else
...
// ============================================================================
// Chat API Handlers (KV4P only)
// ============================================================================

/**
 * @brief Handler for GET /api/chat/messages — list chat messages since given ID
 */
