...
pub mod group_change {
    ...
    pub struct Actions {
        ...
        pub modify_member_roles: ::prost::alloc::vec::Vec<
            actions::ModifyMemberRoleAction,
        >,
        #[prost(message, repeated, tag = "6")]
        pub modify_member_profile_keys: ::prost::alloc::vec::Vec<
            actions::ModifyMemberProfileKeyAction,
        >,
        #[prost(message, repeated, tag = "7")]
        pub add_pending_members: ::prost::alloc::vec::Vec<
            actions::AddPendingMemberAction,
        >,
        #[prost(message, repeated, tag = "8")]
        pub delete_pending_members: ::prost::alloc::vec::Vec<
            actions::DeletePendingMemberAction,
        >,
        #[prost(message, repeated, tag = "9")]
        pub promote_pending_members: ::prost::alloc::vec::Vec<
            actions::PromotePendingMemberAction,
        >,
        ...
        pub modify_disappearing_messages_timer: ::core::option::Option<
            actions::ModifyDisappearingMessagesTimerAction,
        >,
        #[prost(message, optional, tag = "13")]
        pub modify_attributes_access: ::core::option::Option<
            actions::ModifyAttributesAccessControlAction,
        >,
        #[prost(message, optional, tag = "14")]
        pub modify_member_access: ::core::option::Option<
            actions::ModifyMembersAccessControlAction,
        >,
        #[prost(message, optional, tag = "15")]
        pub modify_add_from_invite_link_access: ::core::option::Option<
            actions::ModifyAddFromInviteLinkAccessControlAction,
        >,
        #[prost(message, repeated, tag = "16")]
        pub add_requesting_members: ::prost::alloc::vec::Vec<
            actions::AddRequestingMemberAction,
        >,
        #[prost(message, repeated, tag = "17")]
        pub delete_requesting_members: ::prost::alloc::vec::Vec<
            actions::DeleteRequestingMemberAction,
        >,
        #[prost(message, repeated, tag = "18")]
        pub promote_requesting_members: ::prost::alloc::vec::Vec<
            actions::PromoteRequestingMemberAction,
        >,
        #[prost(message, optional, tag = "19")]
        pub modify_invite_link_password: ::core::option::Option<
            actions::ModifyInviteLinkPasswordAction,
        >,
        #[prost(message, optional, tag = "20")]
        pub modify_description: ::core::option::Option<actions::ModifyDescriptionAction>,
        #[prost(message, optional, tag = "21")]
        pub modify_announcements_only: ::core::option::Option<
            actions::ModifyAnnouncementsOnlyAction,
        >,
        #[prost(message, repeated, tag = "22")]
        pub add_banned_members: ::prost::alloc::vec::Vec<actions::AddBannedMemberAction>,
        #[prost(message, repeated, tag = "23")]
        pub delete_banned_members: ::prost::alloc::vec::Vec<
            actions::DeleteBannedMemberAction,
        >,
        #[prost(message, repeated, tag = "24")]
        pub promote_pending_pni_aci_members: ::prost::alloc::vec::Vec<
            actions::PromotePendingPniAciMemberProfileKeyAction,
        >,
    }
    ...
    pub mod actions {
        ...
        pub struct PromotePendingPniAciMemberProfileKeyAction {
            ...
            /// Only set when receiving from server
            #[prost(bytes = "vec", tag = "3")]
            pub pni: ::prost::alloc::vec::Vec<u8>,
            /// Only set when receiving from server
            #[prost(bytes = "vec", tag = "4")]
            pub profile_key: ::prost::alloc::vec::Vec<u8>,
        }
...
pub struct GroupResponse {
    ...
    #[prost(bytes = "vec", tag = "2")]
    pub group_send_endorsements_response: ::prost::alloc::vec::Vec<u8>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct GroupChangeResponse {
    #[prost(message, optional, tag = "1")]
    pub group_change: ::core::option::Option<GroupChange>,
    #[prost(bytes = "vec", tag = "2")]
    pub group_send_endorsements_response: ::prost::alloc::vec::Vec<u8>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
